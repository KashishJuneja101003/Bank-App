...
public class EmployeeServiceImpl implements EmployeeService {
	...
	@Override
	public EmployeeResponseDto addEmployee(CreateEmployeeRequestDto dto) {
		...
		Employee employee = employeeRepository.save(employeeDtoBuilder.fromRequestDtoForNewEmployee(dto));
	...
	public List<EmployeeResponseDto> getAllEmployees() {
		return employeeRepository.findAll().stream().map(employeeDtoBuilder::toResponseDto).toList();
	}
